...
zokou({ nomCom: 'uptime',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_uptime STANY-TECH-MD-BOT bot is: ${runtime(process.uptime())}_*`) 
...
await zk.sendMessage(dest, { image: res, caption: '𝑾𝒆𝒃 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝒃𝒚 * STANY-TECH-MD-BOT*'}, { quoted: ms });
